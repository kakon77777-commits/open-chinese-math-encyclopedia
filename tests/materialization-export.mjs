...
assert.match(check.stdout, /Materialization task export check passed: 71 task\(s\)/)

console.log('Materialization export tests passed: committed JSONL exactly matches the 71-task derivation.')
