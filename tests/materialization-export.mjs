...
assert.match(check.stdout, /Materialization task export check passed: 66 task\(s\)/)

console.log('Materialization export tests passed: committed JSONL exactly matches the 66-task derivation.')
